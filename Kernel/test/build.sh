...
cd ../core
echo "\tbuilding core..."
as_r -v ../conf/header.s ../buf.s ../filsys.s core.s main.s prf.s
echo -n "core size: "
size_r a.out
mv a.out ../conf/obj/core.o

echo "\tbuilding blkio..."
as_r -v ../conf/header.s ../buf.s ../dev.s blkio.s bio.s
echo -n "blkio size: "
size_r a.out
mv a.out ../conf/obj/blkio.o

echo "\tbuilding fs..."
as_r -v ../conf/header.s ../buf.s ../filsys.s fs.s alloc.s iget.s subr.s
echo -n "fs size: "
size_r a.out
...
# build devices
cd ../dev
as_r ../conf/header.s ../buf.s shd.s ; mv a.out ../conf/obj/shd.o
